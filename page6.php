...
<?php
    ...
    <div style="display: flex; gap:200px; justify-content: center; padding-top: 100px; padding-bottom: 100px;">
        <div align="center" class="selected">Furniture</div>
        <div align="center" class="not-selected"><a href="page7.php">Lighting</a></div>
        <div align="center" class="not-selected"><a href="page8.php">Decor</a></div>
    </div>

    <div style="display: grid; gap: 70px; margin: 0 200px 0 200px; border: 1px black solid;">
        <div align="center" style="font-size: 1.5rem; padding-top: 10px;">Furniture</div>
        <div style="display: flex; gap: 50px; justify-content: center;">
            <div align="center">
                <img src="images/bed.webp" alt="" height="170px" width="200px">
                <p>Beds</p>
            </div>
            <div align="center">
                <img src="images/stand.webp" alt="" height="170px" width="200px">
                <p>NightStand Tables</p>
            </div>
            <div align="center">
                <img src="images/sofa.jpg" alt="" height="170px" width="200px">
                <p>Sofa</p>
            </div>
            <div align="center">
                <img src="images/table.jpg" alt="" height="170px" width="200px">
                <p>Table</p>
            </div>
        </div>
    </div>
