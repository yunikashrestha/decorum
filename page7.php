...
<?php
    ...
    <div style="display: flex; gap:200px; justify-content: center; padding-top: 100px; padding-bottom: 100px;">
        ...
        <div align="center" class="selected">Lighting</div>
    ...
    <div style="display: grid; gap: 70px; margin: 0 200px 0 200px; border: 1px black solid;">
        <div align="center" style="font-size: 1.5rem; padding-top: 10px;"> Lighting</div>
        <div style="display: flex; gap: 50px; justify-content: center;">
            <div align="center">
                <img src="images/ceiling 1.webp" alt="" height="170px" width="200px">
                <p>Ceiling Lighting</p>
            </div>
            <div align="center">
                <img src="images/lamp.webp" alt="" height="170px" width="200px">
                <p>Lamps</p>
            </div>
            <div align="center">
                <img src="images/walllight.webp" alt="" height="170px" width="200px">
                <p>Wall Lighting</p>
            </div>
            <div align="center">
                <img src="images/c.jpg" alt="" height="170px" width="200px">
                <p>Chandelier</p>
            </div>
        </div>
    </div>
