...
<body>
    ...
    gap:100px; padding-top: 30px;">
        ...
        <div class="living"align="center"><a href="page3.php">Living room</a></div>
        <div class="living"align="center" ><a href="page4.php">Bedroom</a></div>
        <div class="living"align="center"style="color:white;background-color: black;" >Dining room</div>
        
    </div >
    <div style="display: flex;justify-content: center;padding-top: 50px;">
        <img src="images/dining.jpg"height=400px width=1000px;>
    </div>
    <div class="page5">
